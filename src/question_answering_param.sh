...
$DIR/question_answering_param.py $@
...
python2.6 /dropbox/13-14/573/code/compute_mrr.py /dropbox/13-14/573/Data/patterns/devtest/factoid-docs.litkowski.2006.txt $DIR/../outputs/$1.outputs strict lenient > $DIR/../results/$1.results_lenient
